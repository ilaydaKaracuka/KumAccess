...
- 
## 💾 Veritabanı Yedeği
Projede kullanılan SQL Server veritabanı yedeğine aşağıdan ulaşabilirsiniz: [📂 kumaccess.bak](https://github.com/ilaydaKaracuka/PDKS/raw/main/database/kumaccess.bak)
